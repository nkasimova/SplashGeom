...
BeachNode::BeachNode()
	: arc_(nullptr), break_point_(), parent_(nullptr), left_node_(nullptr), right_node_(nullptr) {}

BeachNode::BeachNode(const Arc& arc)
	: arc_(make_shared<Arc>(arc)), break_point_(), parent_(nullptr), left_node_(nullptr), right_node_(nullptr) {}
